 ...
 * Hub plane per ADR-0088 (agent-runtime-core dissolution; relocated here
 * from {@code ascend.springai.service.runtime.s2c.spi}).
 *
 ...
 */
package ascend.springai.bus.spi.s2c;
