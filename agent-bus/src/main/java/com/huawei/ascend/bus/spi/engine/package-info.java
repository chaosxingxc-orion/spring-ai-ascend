 ...
 * by no single engine and survives extraction of agent-core into
 * its own repository.
 *
 ...
 * ({@code bus.spi.engine}). agent-runtime drives engines through this contract;
 * agent-core implements it. Neither module depends on the other.
 *
