 ...
 * {@link com.huawei.ascend.engine.runtime.EngineEnvelope} (engine request shape
 * mirroring {@code docs/contracts/engine-envelope.v1.yaml}). The package is NOT
 * the engine SPI surface — that is {@code com.huawei.ascend.engine.spi.*}; the SPI
 ...
 * 2026-05-20) relocated them to {@code com.huawei.ascend.engine.runtime.*}
