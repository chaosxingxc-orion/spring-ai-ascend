package ascend.springai.engine.orchestration.spi;
 ...
 *   {@code ascend.springai.bus.spi.s2c.S2cCallbackEnvelope} (typed as
...
public final class SuspendSignal extends Exception {
    ...
    private final Object clientCallback;         // typed Object for SPI purity (E3); actual type
                                                  // is ascend.springai.bus.spi.s2c.S2cCallbackEnvelope.
     ...
     * {@code ascend.springai.bus.spi.s2c.S2cCallbackEnvelope} (relocated
     * from {@code ascend.springai.service.runtime.s2c} in v2.0.0-rc3 per α-4 / β-2);
