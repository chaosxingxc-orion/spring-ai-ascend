 ...
 * capabilities. A runtime can provide this as a separate Bean, or a concrete
 * business handler can implement both interfaces when that is the simplest
 * shape. The Agent Card is A2A protocol metadata by nature, so this supplier
 * lives in the protocol bridge package rather than the neutral SPI.
 */
