 ...
 * which is used by EngineDispatcher to find the registered AgentRuntimeHandler via
 * AgentRuntimeHandlerRegistry.findByAgentId(scope.agentId), then execute the handler.
 *
 * <p>Constraints:
 * <ul>
