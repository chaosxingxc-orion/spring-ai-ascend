 ...
 *
 * <p>One record instead of three constructor parameters keeps the context's
 * construction surface flat: a future capability grows this record, not every
 * {@code AgentExecutionContext} construction site. Every component is
 * nullable — a hosting application that does not wire a capability simply
