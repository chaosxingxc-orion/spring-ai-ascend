...
- ✓ baseline-rw load/save/validate
- ✓ step 8 baseline-freeze skill
- ◐ renderer delta 模式(step 3 更新稿;接口预留)
- ◐ step 3 arch-update-draft skill
- ✗ puml→SVG 渲染管线(独立议题,见 build-plan §6.1 / §9 Q5)
- ✗ v2 9 步编号迁移(独立切片 S0)
