...
- Architecture baseline: **65 §4 constraints · 100 ADRs · 133 active gate rules · 238 gate self-tests** · 13 Layer-0 governing principles · 168 enforcer rows · 42 active engineering rules (D-/R-/G-/M- namespace per [ADR-0086](docs/adr/0086-rule-namespace-ratchet.yaml)) · 5 phase contracts + 6 phase-loading skills (docs/governance/contracts/ + .claude/skills/<phase>-mode.md per ADR-0098) · 12 recurring defect families catalogued · 374 Maven tests green · 468 architecture-graph nodes / 831 edges. Canonical structured baseline lives in [`docs/governance/architecture-status.yaml#architecture_sync_gate.baseline_metrics`](docs/governance/architecture-status.yaml) (single source of truth). Wave history lives at [`docs/logs/governance-waves.md`](docs/logs/governance-waves.md). Gate enforcement includes Rule G-2.b + Rule G-2.d + Rule G-2.1.a + Rule G-5.a + Rule G-5.b + Rule G-5.c + Rule 101 + Rule 105 + Rule 106 + Rule 107 + Rule 108 + Rule 109 + Rule 110 META + Rule 111 [META] + Rule 112 META-of-META + Rule 113 paren guard + Rule 114 filename convention + Rule 115 D-9 metadata gate + Rule 121 whitebox_quality_reports.
