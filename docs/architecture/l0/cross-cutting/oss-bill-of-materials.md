...
- `com.huawei.ascend.bus.spi.engine.Checkpointer` — dev-posture: `InMemoryCheckpointer`; W2: Postgres-backed.
...
- `com.huawei.ascend.bus.spi.engine.Orchestrator` — W0: `SyncOrchestrator` reference impl.
